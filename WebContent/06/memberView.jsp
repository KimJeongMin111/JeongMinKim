...
<script type="text/javascript">
   $(function(){
	   ...
	   var mem_hp1 = '<%=memberInfo.getMem_hp().split("-")[0] %>';
	      $('select[name=mem_hp1] option[value="' + mem_hp1 + '"]').attr("selected", true);
	      
	      var mem_hometel1 = '<%=memberInfo.getMem_hometel().split("-")[0]%>';
	      $('select[name=mem_hometel1] option[value="' + mem_hometel1 + '"]').attr("selected", true);

	      var mem_mail2 = '<%=memberInfo.getMem_mail().split("@")[1]%>';
	      $('select[name=mem_mail2] option[value="' + mem_mail2+ '"]').attr("selected", true);
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin-top: 10px;">
   ...
   <tr>
      ...
      <td>
         ...
         <button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-button--accent" onclick="zipcodePopup();">우편번호검색</button><br>
