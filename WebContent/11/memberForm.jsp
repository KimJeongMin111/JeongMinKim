...
$(function() {
	...
	$('#btn1').click(function() {
		$(location).attr('href', '<%=request.getContextPath()%>/11/insertMemberInfo.jsp');
	});
	$('#btn2').click(function() {
		$(location).attr('href', '<%=request.getContextPath()%>/11/loginForm.jsp');
	});
	$('#btn3').click(function() {
		$(location).attr('href', '<%=request.getContextPath()%>/11/main.jsp?contentPage=/06/memberList.jsp');
	});
