...
<%
	...
	Map<Object, Object> buyerInfo = service.buyerInfo(params);
...
<script type="text/javascript">
	$(function(){
		...
		$('#btn2').click(function(){
			var id = $('input[name=buyer_id]').val();
			$(location).attr('href', '<%=request.getContextPath()%>/11/deleteBuyerInfo.jsp?buyer_id=' + id); 
		});
...
<body>
<form action="<%=request.getContextPath()%>/11/updateBuyerInfo.jsp" name="buyerForm" method="post">
<table width="600" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td class="fieldName" width="100px" height="25">거래처코드</td>
		<td>
			<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
				<input value="<%=buyerInfo.get("BUYER_ID") %>" class="mdl-textfield__input" type="text" id="buyer_id" name="buyer_id" disabled="disabled">
				<input value="<%=buyerInfo.get("BUYER_ID") %>" class="mdl-textfield__input" type="hidden" id="buyer_id" name="buyer_id">
	...
	<tr>
		...
		<td>
			<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
				<input value="<%=buyerInfo.get("BUYER_NAME") %>" class="mdl-textfield__input" type="text" id="buyer_name" name="buyer_name">
	...
	<tr>
		...
		<td>
			<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
				<input value="<%=buyerInfo.get("BUYER_CHARGER") %>" class="mdl-textfield__input" type="text" id="buyer_charger" name="buyer_charger">
	...
	<tr>
		...
		<td>
			<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
				<input value="<%=buyerInfo.get("BUYER_BANK") %>" class="mdl-textfield__input" type="text" id="buyer_bank" name="buyer_bank">
	...
	<tr>
		...
		<td>
			<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
				<input value="<%=buyerInfo.get("BUYER_ADD1") %>" class="mdl-textfield__input" type="text" id="buyer_add1" name="buyer_add1">
	...
	<tr>
		...
		<td>
			<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
				<input value="<%=buyerInfo.get("BUYER_ADD2") %>" class="mdl-textfield__input" type="text" id="buyer_add2" name="buyer_add2">
...
<table width="600" border="0" cellpadding="0" cellspacing="0" style="margin-top: 10px;">
	<tr>
		...
		<td>
			<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
				<input value="<%=buyerInfo.get("BUYER_COMTEL") %>" class="mdl-textfield__input" type="text" id="buyer_comtel" name="buyer_comtel">
	...
	<tr>
		...
		<td>
			<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
				<input value="<%=buyerInfo.get("BUYER_FAX") %>" class="mdl-textfield__input" type="text" id="buyer_fax" name="buyer_fax">
	...
	<tr>
		...
		<td>
			<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
				<input value="<%=buyerInfo.get("BUYER_MAIL") %>" class="mdl-textfield__input" type="text" id="buyer_mail" name="buyer_mail">
