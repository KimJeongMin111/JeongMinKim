...
String.prototype.validationPROID = function(){
	return /^[A-Z][0-9]$/.test(this);
};

String.prototype.validationPRONAME = function(){
	return /^[A-Za-z0-9]{1,40}$/.test(this);
};
