...
// 	   console.log(Get_Cookie('mem_id'));
	   if(Get_Cookie('mem_id')){
         ...
         $('.loginBtn').click(function(){
            ...
            var $frm = $('<form action="<%=request.getContextPath()%>/10/loginCheck.jsp" method="POST"></form>'); 
						...
						<td>
							<table border="0" align="center" cellpadding="5"
								...
								<tr>
		                           ...
		                           <a href="<%=request.getContextPath() %>/10/main.jsp?contentPage=/10/memberForm.jsp">회원가입을 원하세요??</a></td>
		                        </tr>
							</table>
						</td>
					</tr>
