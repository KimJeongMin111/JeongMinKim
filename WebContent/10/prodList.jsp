...
<script type="text/javascript">
	$(function(){
		$('table tr:gt(0)').click(function(){
			...
			location.href = '<%=request.getContextPath()%>/10/main.jsp?contentPage=/10/prodView.jsp?prod_id=' + prod_id;
		});
		
		$('#btn2').click(function(){
			$(location).attr('href', '<%=request.getContextPath()%>/10/main.jsp?contentPage=/10/prodForm.jsp');
		});
	});
</script>
</head>
...
<div class="searchForm" align="right" style="margin-top: 10px;">
	<form method="post" action="">
		...
		<button class="mdl-button mdl-js-button mdl-button--raised mdl-button--accent" type="button" id="btn2">상품등록</button>
	</form>
</div>
</body>
</html>
